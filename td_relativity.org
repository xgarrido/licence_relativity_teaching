...
#+BEGIN_QUESTION
2) Répondre aux mêmes questions dans $\mathcal{R}$. On calculera les champs $\vv{E}$ et $\vv{B}$
   créés par $M_1$ au point $M_2$ de deux manière différentes. On vérifiera la nature covariante de
   la force de Lorentz.
#+END_QUESTION
