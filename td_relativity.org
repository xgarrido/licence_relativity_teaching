...
- *2^{ème} démonstration* : on considère à présent la mesure des extrémités de la règle $A$ et $B$ au
  même instant $\pmb{t_A=t_B}$ dans $\mathcal{R}$. On a donc deux événements coïncidents repérés
  en coordonnées espace-temps par les quadri-vecteurs
  #+BEGIN_SRC latex
    \begin{align*}
      E_A=
      \begin{pmatrix}
...
[fn:cb0c07154fe6de2] le baryon \Lambda_{0} est une particule "étrange" constituée de 3 quarks de
valence $uds$. La terminologie d'étrangeté vient de la durée de vie particulièrement longue de ces
...
2) [@2]
   ...
   2) Par rapport au début de l'exercice, en associant la particule 1 au muon et la particule 2 au
      ...
      *Application :* Dans notre cas, $m_\pi c^2$ = 140 MeV et $m_\mu c^2$ = 106 MeV soit
      ...
      #+RESULTS:
      [[file:./.ob-jupyter/2d70e46100fbc5bb7679fcb51d012eb9fc0b0409.png]]
...
1) La relation de dilatation du temps implique que l'intervalle de temps $\d t$ dans le référentiel
   ...
   *constantes*, le temps $t$ est alors égal à $\gamma t^*$. Dans cet exercice, le facteur de Lorentz
   ...
   #+RESULTS:
   [[file:./.ob-jupyter/002694ee957dc6b97f0828da162bdd70aee3e55b.png]]
   #+END_SNIPPET
  ...
  #+RESULTS:
  [[file:./.ob-jupyter/8f9f0b2c3f806c0455a17eb651c4ed07739d3b66.png]]
  #+END_SNIPPET
...
#+RESULTS:
[[file:./.ob-jupyter/a27afb53293d3acc9ef28d35b0e6b242f9dcef61.png]]
...
5) [@5] On a
   ...
   #+RESULTS:
   [[file:./.ob-jupyter/a261e447aae09dc78bd2728c2ba298a0ed3a5d45.png]]
   #+END_SNIPPET
...
4) [@4] On a $\phi(\vv{r},t)=\frac{\gamma
   ...
   #+RESULTS:
   [[file:./.ob-jupyter/6e014f0c763d258ce928be87d5bab6ea0ebf18b6.png]]
   #+END_SNIPPET
