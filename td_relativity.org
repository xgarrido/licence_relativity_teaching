...
de retour : elle reçoit donc les signaux tous les 4 mois. Ainsi Alice reçoit un signal pendant
l'aller et 8 signaux pendant le retour.

#+CAPTION: *Diagrammes des signaux émis par Alice (figure de gauche) et par Bob (figure de droite).*
