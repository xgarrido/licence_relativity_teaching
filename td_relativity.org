...
$\vv{v_1}'.\vv{e_x}\neq\vv{v_2}'.\vv{e_x}$. On notera $\alpha$ l'angle entre $\vv{v_1}'$ et
$\vv{v_2}'$.
...
2) Montrer qu'en relativité restreinte $\alpha$ est un angle aigu (indication: exprimer $\cos\alpha$
   ...
   ($\vv{v_1}'.\vv{e_x}=\vv{v_2}'.\vv{e_x}$) on a :
   #+BEGIN_SRC latex
     \begin{align*}
...
2) En mécanique relativiste, la conservation de l'énergie et de l'impulsion s'écrivent au travers du
   quadri-vecteur énergie-impulstion soit
   #+BEGIN_SRC latex
     \begin{align*}
   ...
   #+BEGIN_SRC latex
     \begin{align*}
       ...
       &=\sqrt{\frac{\gamma_1'^2-1}{\gamma_1'+1}}\cdot\sqrt{\frac{\gamma_2'^2-1}{\gamma_2'^2+1}}\geq0\quad(\gamma\geq1)
     \end{align*}
   #+END_SRC
