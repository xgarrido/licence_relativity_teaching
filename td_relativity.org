...
notamment au problème de l'abérration stellaire. Il ne fait nullement mention de l'expérience de
...
#+BEGIN_SRC latex
  \begin{align*}
  \Delta t = t_\text{vol}-t_\text{sol}&=\frac{t_\text{sol}}{\gamma}-t_\text{sol}\\
...
#+BEGIN_SRC latex
  \begin{align*}
    ...
    &=\unit[-5.8\cdot10^{-8}]{s}=\unit[-56]{ns}
  \end{align*}
#+END_SRC
ce qui, au regard des précisions sur les mesures de temps, est tout à fait estimable et mesurable.
...
#+BEGIN_SRC latex
  ...
  \end{align*}
#+END_SRC
soit au total 1 nanoseconde pour 5 ans de RER à raison de 200 aller-retours par an.
...
Le référentiel lié au sol n'est pas interiel/galiléen car il a lui-même un mouvement et donc une
vitesse par rapport au référentuel géocentrique. La Terre a une vitesse de rotation
$v_\text{rot.}=\nicefrac{2\pi
